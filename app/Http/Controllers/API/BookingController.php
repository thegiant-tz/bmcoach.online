...
class BookingController extends Controller
{
    ...
    function store(Request $request)
    {
        try {
            ...
            $bookingQuery = $timetable->bookings()->whereSeatNo($request->seat_no);
            if (is_null($bookingQuery->first()) || !is_null($bookingQuery->whereAgentId($agentId)->whereStatus('Processing')->first())) {
